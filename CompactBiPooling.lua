...
function ComBiPooling:genRand(size_1, size_2)
    --torch.manualSeed()
    self.rand_h_1 = torch.Tensor(size_1):uniform(0,self.output_size):ceil():long():cuda()
    self.rand_h_2 = torch.Tensor(size_2):uniform(0,self.output_size):ceil():long():cuda()
